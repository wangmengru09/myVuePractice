    ...
    >
      <el-form-item label="活动名称" prop="name">
        <el-input
          ...
          name="focusItem-1"
          v-focus="{index: 1, type: 'input', disabled: false, callback}"
        ></el-input>
      </el-form-item>
        ...
        <el-col :span="11">
          <el-form-item prop="date1">
            <el-input
              v-model="ruleForm.name"
              name="focusItem-1"
              v-focus="{index: 3, type: 'input', disabled: false, callback}"
            ></el-input>
      ...
      <el-form-item label="即时配送" prop="delivery">
        <el-switch
          ...
          v-focus="{index: 4, type: 'switch', disabled: false}"
        ></el-switch>
      </el-form-item>
      <el-form-item label="活动性质" prop="type">
        <el-checkbox-group
          v-model="ruleForm.type"
          v-focus="{index: 5, type: 'checkbox', disabled: false}"
        >
      ...
      <el-form-item label="特殊资源" prop="resource">
        <el-radio-group
          ...
          v-focus="{index: 6, type: 'radio', disabled: false}"
        >
      ...
      <el-form-item label="活动形式" prop="desc">
        <el-input
          ...
          name="focusItem-8"
          v-focus="{index: 7, type: 'input', disabled: false}"
        ></el-input>
      </el-form-item>
      <el-form-item>
...
export default {
  ...
  mounted() {
    ...
    // console.log(this.$store.getters.currentFocus)
  },
  methods: {
    submitForm(formName) {
